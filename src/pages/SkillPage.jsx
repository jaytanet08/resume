        ...
        >
            <div className='div-main-skil'>
                <div className='div-label'>
                    <label className='label-title'>Fontend</label>
                </div>
                ...
                <div className='div-label'>
                    <label className='label-title'>Backend</label>
                </div>
                <div className='div-img-main'>
                    <div className='div-img-skill'>
                ...
                <div className='div-label'>
                    <label className='label-title'>Database</label>
                </div>
                <div className='div-img-main'>
                    <div className='div-img-skill'>
                ...
                <div className='div-label'>
                    <label className='label-title'>Tool</label>
                </div>
                <div className='div-img-main'>
                    <div className='div-img-skill'>
                ...
                <div className='div-label'>
                    <label className='label-title'>Cloud</label>
                </div>
                <div className='div-img-main'>
                    <div className='div-img-skill'>
